...
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[WebTKS]
#     EXE_FILES => [q[script/webtks_cgi.pl], q[script/webtks_create.pl], q[script/webtks_fastcgi.pl], q[script/webtks_server.pl], q[script/webtks_test.pl]]
#     LICENSE => q[perl]
#     NAME => q[WebTKS]
#     NO_META => q[1]
...
WebTKS.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"WebTKS\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
EXE_FILES = script/webtks_cgi.pl script/webtks_create.pl script/webtks_fastcgi.pl script/webtks_server.pl script/webtks_test.pl

pure_all :: $(INST_SCRIPT)\webtks_create.pl $(INST_SCRIPT)\webtks_server.pl $(INST_SCRIPT)\webtks_test.pl $(INST_SCRIPT)\webtks_fastcgi.pl $(INST_SCRIPT)\webtks_cgi.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)\webtks_create.pl $(INST_SCRIPT)\webtks_server.pl \
	  $(INST_SCRIPT)\webtks_test.pl $(INST_SCRIPT)\webtks_fastcgi.pl \
	  $(INST_SCRIPT)\webtks_cgi.pl 
